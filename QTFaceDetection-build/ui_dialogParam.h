...
public:
    ...
    void setupUi(QDialog *DialogParam)
    {
        ...
        verticalLayout = new QVBoxLayout(DialogParam);
        ...
        label_5 = new QLabel(DialogParam);
        label_5->setObjectName(QStringLiteral("label_5"));

        gridLayout->addWidget(label_5, 4, 0, 1, 1);

        lineEditLight = new QLineEdit(DialogParam);
        lineEditLight->setObjectName(QStringLiteral("lineEditLight"));

        gridLayout->addWidget(lineEditLight, 4, 1, 1, 1);
    ...
    void retranslateUi(QDialog *DialogParam)
    {
        ...
        label_5->setText(QApplication::translate("DialogParam", "\345\205\211\347\272\277\350\260\203\346\225\264", 0));
    } // retranslateUi
